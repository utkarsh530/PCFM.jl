# Credits: https://github.com/LuxDL/Lux.jl/blob/ap/ho-enzyme/ext/LuxEnzymeExt/batched_autodiff.jl
...
function Lux.AutoDiffInternalImpl.batched_jacobian_internal(
    ...
    return batched_enzyme_jacobian_impl(f, ad, ADTypes.mode(backend), x, args...)
end
